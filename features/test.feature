...
Функционал: тестовый
  ...
  Сценарий: валидатор
    ...
    * в "0" строке колонки "country" таблицы "countries" содержится "Denmark"
